        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100">
          <div className="space-y-6">
            {accomplishments.map((item) => (
              ...
              >
                <div
                  className="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-lg p-6 
                    ...
                    <div className="mt-6 h-2 w-full bg-gray-100 rounded-full overflow-hidden">
                      <div
                        className={`h-full transition-all duration-500 ease-out
                          ...
                          ${
                            item.status === "In Progress"
                              ? "w-1/2 bg-gradient-to-r from-yellow-400 to-orange-500"
                              : ""
                          }
                          ${
                            item.status === "Pending"
                              ? "w-1/4 bg-gradient-to-r from-blue-400 to-indigo-500"
                              : ""
                          }
                        `}
                      />
