...
import { Form, Input, Button, Select, DatePicker, message, Spin, Card, Typography, Divider } from "antd";
import { UserOutlined, PhoneOutlined, HomeOutlined, CalendarOutlined, ArrowLeftOutlined, SaveOutlined } from "@ant-design/icons";
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 px-8 py-6 text-white">
          <div className="flex items-center justify-between">
            ...
            <Title level={3} className="m-0 text-white">Update Account</Title>
