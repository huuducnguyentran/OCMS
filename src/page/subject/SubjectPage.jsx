import { Card, Empty, Modal, message, Spin, Input, Tag, Typography, Tooltip, Badge } from "antd";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate__animated animate__fadeIn">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Explore our comprehensive collection of training subjects designed to enhance your learning journey
            </p>
          </div>
        </div>
      </div>
            ...
            description={
              <div className="text-center space-y-4">
                <p className="text-gray-500 text-lg">
                  {searchText ? `No subjects matching "${searchText}"` : "No subjects available"}
                </p>
                <button
                ...
                actions={[
                  ...
                  <Tooltip title="Edit Subject">
                    <EditOutlined
                      ...
                      onClick={() => navigate(`/subject-edit/${subject.subjectId}`)}
                    />
                  </Tooltip>,
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mt-4 pt-4 border-t">
                    <Tooltip title="Credits">
                      <Tag
                        color={subject.credits <= 3 ? "success" : subject.credits <= 6 ? "warning" : "error"}
                    ...
                    <Tooltip title="Passing Score">
                      <Tag
                        color={subject.passingScore <= 4 ? "success" : subject.passingScore <= 7 ? "warning" : "error"}
                        className="px-3 py-1 flex items-center gap-1"
                      >
