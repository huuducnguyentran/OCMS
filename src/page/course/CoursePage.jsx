...
const CoursePage = () => {
  ...
  useEffect(() => {
    ...
    if (progressFilter) {
      currentCourses = currentCourses.filter(
        (course) => course.progress === progressFilter
      );
    }
    ...
    if (dateRange && dateRange.length === 2) {
      ...
      currentCourses = currentCourses.filter((course) => {
        const createdAt = dayjs(course.createdAt);
        if (!createdAt.isValid()) return false;

        return (
          createdAt.isSameOrAfter(from, "day") &&
          createdAt.isSameOrBefore(to, "day")
        );
      });
    }
    ...
    setCurrentPage(1);
  }, [courses, searchText, statusFilter, progressFilter, dateRange]);
  ...
  const currentDisplayCourses = filteredCourses.slice(
    indexOfFirstCourse,
    indexOfLastCourse
  );
    ...
    <div className="mb-6">
      <div className="flex flex-wrap justify-end gap-4 mb-6">
        ...
        <Button
          ...
          className="!text-cyan-600 !border-cyan-600 hover:!border-cyan-800 hover:!text-cyan-800 !mr-auto"
        >
          <ClearOutlined className="!text-cyan-600" />
          Clear All Filters
        </Button>
        ...
        <Select
          ...
          className="!w-48"
        >
          <Select.Option value="NotYet">Not Started</Select.Option>
  ...
  return (
    <Layout className="!min-h-screen !bg-gradient-to-br from-cyan-50 via-white to-cyan-100 !p-6 !sm:p-8">
      <Layout.Content className="!min-w-7xl !max-w-7xl !mx-auto">
                ...
                >
                  ...
                  >
                    <div className="flex-grow">
                      <Paragraph>
                        <Text strong>ID:</Text> {course.courseId}
                      </Paragraph>
                      ...
                      <Paragraph>
                        <Text strong>Level:</Text> {course.courseLevel}
                      </Paragraph>
                      <Paragraph>
                        <Text strong>Progress:</Text>{" "}
                        <Tag color={getProgressColor(course.progress)}>
                          {course.progress}
                        </Tag>
                      </Paragraph>
                    </div>
                    <Text
                      type="secondary"
                      className="block text-xs mt-auto pt-2 border-t border-gray-100"
                    >
